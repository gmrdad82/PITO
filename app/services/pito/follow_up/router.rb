...
module Pito
  module FollowUp
    ...
    #   - Works alongside Pito::ConfirmationRouter during the P13 transition:
    #     confirmation events carry `confirmation_handle`, not `reply_handle`, so
    #     they always fall through to :not_found here and the old confirmation
    #     branch handles them.
    class Router
