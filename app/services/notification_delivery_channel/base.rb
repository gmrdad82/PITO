...
# `last_validated_at`). The PORO dispatcher logic moves into THIS
# class (`NotificationDeliveryChannel::Base`) so the canonical constant
# `NotificationDeliveryChannel` can be the AR model.
#
