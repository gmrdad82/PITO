...
#
# Renamed from `Game::RatingHeatBarComponent` (2026-05-25). The old class
# is kept as a deprecated thin subclass alias for one sweep so existing call
...
#
# variants: muted (nil score or no game), scored (score present), resyncing.
#
# related: Game::RatingScoreChipComponent (reuses class-level helpers here),
#          Game::RatingHeatBarComponent (deprecated alias → this class).
class Pito::ScoreBarComponent < ViewComponent::Base
  ...
  # Tier thresholds shared with `Game::RatingBadgeComponent`.
  TIERS = [
    [ 90, "excellent" ],
    [ 80, "good"      ],
    [ 70, "fair"      ],
