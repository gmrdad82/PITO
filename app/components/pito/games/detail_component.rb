...
module Pito
  module Games
    ...
    class DetailComponent < ViewComponent::Base
      ...
      # Absolute IGDB last-sync stamp via the shared SyncStamp (a game's data
      # syncs from IGDB, so igdb_synced_at IS its "last sync"); "—" when never synced.
      def last_sync_label
      ...
      def top_shinies_per_metric
        Pito::Achievements::TopShiniesPerMetric.call(@game.achievements)
      end
