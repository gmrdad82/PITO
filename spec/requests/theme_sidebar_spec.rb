...
# P8 — Bare /theme opens the theme picker sidebar (Turbo Stream update to #pito-sidebar).

RSpec.describe "POST /chat with bare /theme", type: :request do
  ...
  describe "when authenticated" do
    ...
    it "returns 200 OK" do
      post chat_path, params: { input: "/theme", uuid: conversation.uuid }
    ...
    it "does NOT echo /theme or enqueue a ChatDispatchJob" do
      expect {
        post chat_path, params: { input: "/theme", uuid: conversation.uuid }
