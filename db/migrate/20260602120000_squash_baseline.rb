...
# Squash baseline — replaces all prior individual migrations.
# Generated from db/schema.rb on 2026-06-02.
#
...
class SquashBaseline < ActiveRecord::Migration[8.1]
  def up
  ...
  def down
    raise ActiveRecord::IrreversibleMigration, "Cannot reverse the baseline squash migration."
  end
end
