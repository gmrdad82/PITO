...
- [ ] T1.1 Write a migration to drop the `game_platform_ownerships` table (reversible). complexity: [low]
- [ ] T1.2 Delete `app/models/game_platform_ownership.rb`. complexity: [low]
- [ ] T1.3 Remove `has_many :game_platform_ownerships` from `app/models/game.rb`. complexity: [low]
- [ ] T1.4 Remove ownership branch from `app/services/pito/chat/handlers/update.rb`. complexity: [high]
- [ ] T1.5 Remove ownership rendering from `app/components/pito/game/detail_component.rb`. complexity: [low]
- [ ] T1.6 Remove ownership markup from `app/components/pito/game/detail_component.html.erb`. complexity: [low]
- [ ] T1.7 Remove ownership branch from `app/services/pito/follow_up/handlers/game_detail.rb`. complexity: [high]
- [ ] T1.8 Remove ownership grammar from `lib/pito/grammar/specs.rb`. complexity: [high]
- [ ] T1.9 Remove ownership keys from `config/locales/pito/grammar/en.yml`. complexity: [low]
- [ ] T1.10 Remove ownership keys from `config/locales/pito/game/en.yml`. complexity: [low]
- [ ] T1.11 Remove ownership copy from `config/locales/pito/copy/en.yml`. complexity: [low]
- [ ] T1.12 Remove any ownership reference in `app/services/game/igdb/importer.rb`. complexity: [low]
- [ ] T1.13 Delete ownership specs and assertions across `spec/`. complexity: [high]
- [ ] T1.14 Run `bundle exec rspec` for game model/handler/component specs; make green. complexity: [low]
- [ ] T1.15 Commit: "Drop Game platform ownership". complexity: [manual]
